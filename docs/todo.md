...
| HG-047 | Multilingual SEO schema audit — translate all structured data | 2026-03-08 | Full audit of all 9 languages. Fixed: Organization schema description translated per locale, BreadcrumbList "Home" translated (Startpagina, Startseite, Accueil, Inicio, Hem, Hjem), FAQ schema on product pages translated for all 8 non-EN languages, removed Portuguese from contactPoint (no PT page exists), added Norwegian to contactPoint. |
| HG-048 | Fix H1/H2 nesting — invalid HTML across all languages | 2026-03-08 | Hero banner template had `<h1><h2>...</h2></h1>` nesting. Fixed by stripping nested heading tags in hero-banner.liquid. All heading translations re-registered without h2 wrappers. |
...
| HG-060 | Translate blog listing page title + meta for all 9 languages | 2026-03-08 | Blog title (SV: Artiklar, DA/NO: Artikler), meta_title, and meta_description translated for all 8 non-EN locales. EN meta_description shortened from 174→126 chars. |
| HG-061 | Translate FAQ page H1/title for all languages | 2026-03-08 | FAQ page title translated: FR (Questions Fréquemment Posées), ES (Preguntas Frecuentes), IT (Domande Frequenti), SV (Vanliga Frågor), DA (Ofte Stillede Spørgsmål), NO (Ofte Stilte Spørsmål). Meta title + description added for SV/DA/NO. |
| HG-062 | Shorten all product meta descriptions to <155 chars | 2026-03-08 | FR/ES/IT/DE/NL/SV product meta descriptions shortened across all 16 products. 53 translation updates applied. All now under 155 characters. |
| HG-063 | Add product meta titles for all languages | 2026-03-08 | EN meta_title set on first product (was null). All 8 non-EN meta_title translations added for first product. Meta title for all FR/ES/IT products shortened to <60 chars. |
| HG-064 | Translate IT breadcrumb Home → Pagina iniziale | 2026-03-08 | Italian breadcrumb home_label changed from "Home" to "Pagina iniziale" in seo-schema.liquid for better Italian SEO. |
| HG-065 | Shorten FR homepage meta title | 2026-03-08 | FR homepage meta_title shortened from 64→51 chars: "Hairgenetix \| Mésothérapie Capillaire à Domicile". |
| HG-066 | Add blog meta title + description for all 8 non-EN languages | 2026-03-08 | Translated meta_title and meta_description for blog listing page in NL/DE/FR/ES/IT/SV/DA/NO. All under 60/155 char limits. |
